...
const Color = () => {
    ...
    return (
        <div style={{ height: "300px", overflow:"scroll", zIndex: "9999", background: "rgb(255, 255, 255)", boxShadow: "0 2px 8px rgba(0, 0, 0, 0.49)", borderRadius: "2mm", position: "absolute", top: "80px", left: "44px" }}>
