...
const CanvasTab = ({ pageNumber, totalBoards, goPrev, goNext, addBoard, removeBoard }) => {
    ...
    return (
        <div style={{ position: "fixed", bottom: 70, left: 88, background: "rgb(225, 223, 223)", borderRadius: "4mm", padding: "0.4rem 0.7rem" }}>
            ...
            <div style={{ display: "flex", gap: "8px", justifyContent: "center", alignItems: "center" }}>
                ...
                <button style={{ ...navBtn, fontSize: "1rem", color: "#3a45e4" }} onClick={addBoard} title="New board">
                    <i className="fa-solid fa-plus"></i>
                </button>
                <button style={{ ...navBtn, fontSize: "1rem", color: "red" }} onClick={removeBoard} disabled={pageNumber === 1} title="New board">
